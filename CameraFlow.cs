...
namespace Assets.Scripts
{
    public class CameraFlow : MonoBehaviour
    {
        ...
        public static Vector3 kDownDirection = new Vector3(1f, 0f, 0f);
        ...
        void Update()
        {
            ...
            if (fMoveDeltaX != 0.0f || fMoveDeltaZ != 0.0f || fMoveDeltaY != 0.0f)
            {
                ...
                Vector3 kUp = Vector3.Cross(kDownDirection, new Vector3(0, 0, Mathf.Abs(kForward.z)));
